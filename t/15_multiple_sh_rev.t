# 15_multiple_sh_rev.t # as of 8/7/2004
...
my $lcmsh   = List::Compare->new(\%h0, \%h1, \%h2, \%h3, \%h4);
ok($lcmsh);                             # 2
...
ok($lcmsh->is_member_any('abel'));      # 652
ok($lcmsh->is_member_any('baker'));     # 653
ok($lcmsh->is_member_any('camera'));    # 654
ok($lcmsh->is_member_any('delta'));     # 655
ok($lcmsh->is_member_any('edward'));    # 656
ok($lcmsh->is_member_any('fargo'));     # 657
ok($lcmsh->is_member_any('golfer'));    # 658
ok($lcmsh->is_member_any('hilton'));    # 659
ok($lcmsh->is_member_any('icon' ));     # 660
ok($lcmsh->is_member_any('jerky'));     # 661
ok(! $lcmsh->is_member_any('zebra'));   # 662
...
my $lcmsh_dj   = List::Compare->new(\%h0, \%h1, \%h2, \%h3, \%h4, \%h8);
...
my $lcmshu   = List::Compare->new('-u', \%h0, \%h1, \%h2, \%h3, \%h4);
ok($lcmshu);                            # 679
...
ok($lcmshu->is_member_any('abel'));     # 1135
ok($lcmshu->is_member_any('baker'));    # 1136
ok($lcmshu->is_member_any('camera'));   # 1137
ok($lcmshu->is_member_any('delta'));    # 1138
ok($lcmshu->is_member_any('edward'));   # 1139
ok($lcmshu->is_member_any('fargo'));    # 1140
ok($lcmshu->is_member_any('golfer'));   # 1141
ok($lcmshu->is_member_any('hilton'));   # 1142
ok($lcmshu->is_member_any('icon' ));    # 1143
ok($lcmshu->is_member_any('jerky'));    # 1144
ok(! $lcmshu->is_member_any('zebra'));  # 1145
...
my $lcmshu_dj   = List::Compare->new('-u', \%h0, \%h1, \%h2, \%h3, \%h4, \%h8);
...
my $lcmshun   = List::Compare->new('--unsorted', \%h0, \%h1, \%h2, \%h3, \%h4);
ok($lcmshun);                           # 1162
