...
# FIRST IS MEMBER ANY
ok(is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'abel' } ));
ok(is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'baker' } ));
ok(is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'camera' } ));
ok(is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'delta' } ));
ok(is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'edward' } ));
ok(is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'fargo' } ));
ok(is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'golfer' } ));
ok(is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'hilton' } ));
ok(is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'icon' } ));
ok(is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'jerky' } ));
ok(! is_member_any( { lists => [ \%h0, \%h1, \%h2, \%h3, \%h4 ], item => 'zebra' } ));
