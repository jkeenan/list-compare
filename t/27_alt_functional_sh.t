...
ok(is_member_any( { lists => [ \%h0, \%h1 ], item => 'abel' } ));
ok(is_member_any( { lists => [ \%h0, \%h1 ], item => 'baker' } ));
ok(is_member_any( { lists => [ \%h0, \%h1 ], item => 'camera' } ));
ok(is_member_any( { lists => [ \%h0, \%h1 ], item => 'delta' } ));
ok(is_member_any( { lists => [ \%h0, \%h1 ], item => 'edward' } ));
ok(is_member_any( { lists => [ \%h0, \%h1 ], item => 'fargo' } ));
ok(is_member_any( { lists => [ \%h0, \%h1 ], item => 'golfer' } ));
ok(is_member_any( { lists => [ \%h0, \%h1 ], item => 'hilton' } ));
ok(! is_member_any( { lists => [ \%h0, \%h1 ], item => 'icon' } ));
ok(! is_member_any( { lists => [ \%h0, \%h1 ], item => 'jerky' } ));
ok(! is_member_any( { lists => [ \%h0, \%h1 ], item => 'zebra' } ));
