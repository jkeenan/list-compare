...
$unique_all_ref = get_unique_all( $unsorted, [ \%h0, \%h1, \%h2, \%h3, \%h4 ] );
is_deeply(
...
@complement = get_complement( $unsorted, [ \%h0, \%h1, \%h2, \%h3, \%h4 ], [ 1 ] );
...
$complement_ref = get_complement_ref( $unsorted, [ \%h0, \%h1, \%h2, \%h3, \%h4 ], [ 1 ] );
...
@symmetric_difference =
    get_symmetric_difference( $unsorted, [ \%h0, \%h1, \%h2, \%h3, \%h4 ] );
...
$symmetric_difference_ref =
    get_symmetric_difference_ref( $unsorted, [ \%h0, \%h1, \%h2, \%h3, \%h4 ] );
...
$complement_all_ref = get_complement_all( $unsorted, [ \%h0, \%h1, \%h2, \%h3, \%h4 ] );
is_deeply(
...
$nonintersection_ref =
    get_nonintersection_ref( $unsorted, [ \%h0, \%h1, \%h2, \%h3, \%h4 ] );
