...
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'abel' } ));
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'baker' } ));
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'camera' } ));
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'delta' } ));
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'edward' } ));
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'fargo' } ));
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'golfer' } ));
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'hilton' } ));
ok(! is_member_any( { lists => [ \@a0, \@a1 ], item => 'icon' } ));
ok(! is_member_any( { lists => [ \@a0, \@a1 ], item => 'jerky' } ));
ok(! is_member_any( { lists => [ \@a0, \@a1 ], item => 'zebra' } ));
