...
# FIRST IS MEMBER ANY
ok(is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'abel' } ));
ok(is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'baker' } ));
ok(is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'camera' } ));
ok(is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'delta' } ));
ok(is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'edward' } ));
ok(is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'fargo' } ));
ok(is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'golfer' } ));
ok(is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'hilton' } ));
ok(is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'icon' } ));
ok(is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'jerky' } ));
ok(! is_member_any( { lists => [ \@a0, \@a1, \@a2, \@a3, \@a4 ], item => 'zebra' } ));
