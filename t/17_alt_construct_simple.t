...
ok($lc->is_member_any('abel'));         # 453
ok($lc->is_member_any('baker'));        # 454
ok($lc->is_member_any('camera'));       # 455
ok($lc->is_member_any('delta'));        # 456
ok($lc->is_member_any('edward'));       # 457
ok($lc->is_member_any('fargo'));        # 458
ok($lc->is_member_any('golfer'));       # 459
ok($lc->is_member_any('hilton'));       # 460
ok(! $lc->is_member_any('icon' ));      # 461
ok(! $lc->is_member_any('jerky'));      # 462
ok(! $lc->is_member_any('zebra'));      # 463
...
ok(0 == $lc_dj->get_intersection);      # 489
ok(0 == scalar(@{$lc_dj->get_intersection_ref}));# 490
...
ok($lcu->is_member_any('abel'));        # 835
ok($lcu->is_member_any('baker'));       # 836
ok($lcu->is_member_any('camera'));      # 837
ok($lcu->is_member_any('delta'));       # 838
ok($lcu->is_member_any('edward'));      # 839
ok($lcu->is_member_any('fargo'));       # 840
ok($lcu->is_member_any('golfer'));      # 841
ok($lcu->is_member_any('hilton'));      # 842
ok(! $lcu->is_member_any('icon' ));     # 843
ok(! $lcu->is_member_any('jerky'));     # 844
ok(! $lcu->is_member_any('zebra'));     # 845
...
ok(0 == $lcu_dj->get_intersection);     # 871
ok(0 == scalar(@{$lcu_dj->get_intersection_ref}));# 872
